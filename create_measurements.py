...
def check_args(file_args):
    ...
    try:
        ...
        print("Usage: create_mensurement.sh <positive integer number of records to create>")
...
def main():
    ...
    rum_rows_to_create = 100_000_000
    weather_station_names = []
    weather_station_names = build_weather_station_name_list()
    print(estimate_file_size(weather_station_names, rum_rows_to_create))
    build_test_data(weather_station_names, rum_rows_to_create)
